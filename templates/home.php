		...
		<main id="main" class="site-main" role="main">
			...
			<div class="section-separators">
				<section class="no-border-bg left-pull-visual top-border">
					<div class="grid">
						<div class="center-vertically" style="margin-top: 111px;">
				...
				<section class="right-pull-visual">
					<div class="grid">
						<div class="center-vertically" style="margin-top: 125px;">
						...
						<div style="background: url('http://placehold.it/1613x775')" class="pull"></div>
					</div>
				</section>
				...
				<section class="left-visual flush-both top-border">
					<div class="grid">
						...
						<div class="center-vertically" style="margin-top: 38px;">
				...
				<section class="right-visual flush-bottom">
					<div class="grid">
						...
						<div class="center-vertically" style="margin-top: 129px;">
